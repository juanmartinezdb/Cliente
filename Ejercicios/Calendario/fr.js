const festivosFr = {
  ...
  const mesFr = ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Novembre', 'Décembre'];
  
  let diaSemanaFr = ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"];
    
  let restantePFr = '<p>Il reste <span class="restantes"></span> avant la fin du cours</p>';