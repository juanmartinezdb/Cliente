const festivosGa = {
  ...
  const mesGa = ['Xaneiro', 'Febreiro', 'Marzo', 'Abril', 'Maio', 'Xuño', 'Xullo', 'Agosto', 'Setembro', 'Outubro', 'Novembro', 'Decembro'];
  
  let diaSemanaGa = ["Dom", "Lun", "Mar", "Mér", "Xov", "Ven", "Sáb"];
    
  let restantePGa = '<p>Quedan <span class="restantes"></span> para que remate o curso</p>';