const festivos = {
  ...
  const mes = ['Januar', 'Februar', 'März', 'April', 'Mai', 'Juni', 'Juli', 'August', 'September', 'Oktober', 'November', 'Dezember'];
  
  const diaSemana = ["So", "Mo", "Di", "Mi", "Do", "Fr", "Sa"];
  
    let restanteP = '<p>Es bleiben <span class="restantes"></span>, bis der Kurs endet</p>';