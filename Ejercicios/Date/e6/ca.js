const festivos = {
  ...
  const mes = ['Gener', 'Febrer', 'Març', 'Abril', 'Maig', 'Juny', 'Juliol', 'Agost', 'Setembre', 'Octubre', 'Novembre', 'Desembre'];
  
  let diaSemana = ["Dg", "Dl", "Dt", "Dc", "Dj", "Dv", "Ds"];

  let restanteP = '<p>Queden <span class="restantes"></span> perquè acabi el curs</p>';
