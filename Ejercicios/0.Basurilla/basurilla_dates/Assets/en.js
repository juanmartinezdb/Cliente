const festivosEn = {
  ...
  const mesEn = ['January', 'February', 'March', 'April', 'May', 'June', 'July', 'August', 'September', 'October', 'November', 'December'];
  
  const diaSemanaEn = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"];
  
    let restantePEn = '<p>There are <span class="restantes"></span> left until the course ends</p>';