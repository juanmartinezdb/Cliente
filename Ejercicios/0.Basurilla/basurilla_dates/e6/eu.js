const festivos = {
  ...
  const mes = ['Urtarrila', 'Otsaila', 'Martxoa', 'Apirila', 'Maiatza', 'Ekaina', 'Uztaila', 'Abuztua', 'Iraila', 'Urria', 'Azaroa', 'Abendua'];
  
  let diaSemana = ["Iga", "Ast", "Ast", "Ast", "Ost", "Ost", "Lar"];
    
  let restanteP = '<p><span class="restantes"></span> falta dira ikasturtea amaitzeko</p>';