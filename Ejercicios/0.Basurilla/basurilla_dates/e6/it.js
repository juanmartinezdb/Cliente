const festivos = {
  ...
  const mes = ['Gennaio', 'Febbraio', 'Marzo', 'Aprile', 'Maggio', 'Giugno', 'Luglio', 'Agosto', 'Settembre', 'Ottobre', 'Novembre', 'Dicembre'];
  
  let diaSemana = ["Dom", "Lun", "Mar", "Mer", "Gio", "Ven", "Sab"];
    
  let restanteP = '<p>Rimangono <span class="restantes"></span> fino alla fine del corso</p>';